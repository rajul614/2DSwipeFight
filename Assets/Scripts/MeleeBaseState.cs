...
public class MeleeBaseState : State
{
    ...
    protected State nextState; //different from StateMachine next state. used for children to set next state early for hard transitions
    ...
    public override void OnUpdate()
    {
        ...
        if (nextState!=null && shouldCombo && animator.GetFloat("EarlyExit") > 0f )
        {
